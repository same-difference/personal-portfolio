    ...
    return(
        <section className="relative min-h-screen flex flex-col justify-center items-center" id="projects">
            ...
            <div className="mb-6 columns-1 md:columns-2 lg:columns-3 w-2/3 xl:w-1/2 2xl:w-2/5">
                <Project name="AdvenTour" link="https://www.youtube.com/watch?v=U2pXYz1bzd8" pic="adventour_crop.png" tags="react-native supabase arduino c++" wip="">
                    A theme park day planning app with a custom companion smartwatch.
                </Project>
                <Project name="GuitAR" link="https://devpost.com/software/guitar-o3gw19" pic="guitar_crop.png" tags="unity grokit-core meta-xr-sdk c#" wip="Won 2nd Overall @ KnightHacks 2024">
            ...
            <div className="mb-20 columns-1 md:columns-2 lg:columns-3 w-2/3 xl:w-1/2 2xl:w-2/5">
                <Project name="Meddy" link="https://devpost.com/software/meddy" pic="meddy_crop.png" tags="react tailwind next.js" wip="">
                    Meddy provides a centralized database for patient information for patients and healthcare providers alike.
                </Project>
                <Project name="The Lab" link="https://devpost.com/software/the-lab-hfynjw" pic="the_lab_crop.png" tags="react redux tailwind ink.js" wip="">
                    A choose-your-own-adventure game built to help the player better understand {spoon_theory}.
                </Project>
                <Project name="HookedIn" link="https://devpost.com/software/hookedin-n537qp" pic="hookedin_crop.png" tags="react javascript express.js git" wip="">
                    A react app that uses chatGPT to roast the user's LinkedIn profile.
                </Project>
                <Project name="Book Review Site" link="https://students.gaim.ucf.edu/~di118075/dig3134/assignment06/login.php" pic="book_review_site_crop.png" tags="html css php mySQL" wip="">
                    A proof-of-concept site to practice mySQL databases.
                </Project>
                <Project name="Personal Portfolio" link="https://github.com/same-difference/personal-portfolio" pic="personal_portfolio_crop.png" tags="react typescript framer" wip="">
